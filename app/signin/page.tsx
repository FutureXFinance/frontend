            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-slate-900/50 border border-white/10 rounded-3xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="w-4 h-4 rounded border-white/10 bg-slate-950 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-0"
                                />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-2 bg-white/5 border border-white/10 rounded-xl px-4 py-3 hover:bg-white/10 transition-all">
